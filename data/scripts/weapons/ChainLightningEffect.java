...
public class ChainLightningEffect implements BeamEffectPlugin
{
    ...
    private CombatEntityAPI lastArc = null;
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam)
    {
        ...
        if (lastArc == null || !engine.isEntityInPlay(lastArc))
        {
                    ...
                    || !target.getShield().isWithinArc(beam.getTo())))
            {
                ...
                float damage = WeaponUtils.calculateDamagePerSecond(beam.getWeapon());
                ...
                do
                {
                    ...
                    lastArc = engine.spawnEmpArc(beam.getSource(), source,
